...
* Recall: uncertainty in position grows w/o bound using dead-reckoning alone.
...
* To make this concrete, let's consider a common type of snesor that measures
...
* It is called the innovation since it represents _new_ information.
...
* These take the _predicted_ values for the next tiem step, denoted with the
...
<center>
<img src="contents/assets/kalman_summary.png" width="500" height="300" />
</center>
:::
...
path (moving from top to bottom).
  - The error ellipses grow as the robot moves and then shrinks just afer a jg
...
::: {.column width="40%"}
<center>
<img src="contents/assets/ekfpath_wmap.png" width="500" height="300" />
</center>
<center>
<img src="contents/assets/ekfpath_wmap_closeup.png" width="500" height="300" />
</center>
:::
...
::: {.column width="40%"}
<center>
<img src="contents/assets/ekf_cov_wmap.png" width="500" height="300" />
</center>
<center>
<img src="contents/assets/confbounds.png" width="500" height="300" />
</center>
:::
