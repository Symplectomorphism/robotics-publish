...
## Simulatenous localization and mapping {.smaller}

* Feels like a ''chicken and egg'' problem
  - we need a map to localize and
  - we need to localize to make a map.
* However, based on what we ahve learned so far this problem is now quite
...
## SLAM -- path
Simulatenous localization and mapping showing the true (_blue_) and estimated
...
map as well as the vehicle pose. It is as if all the states were connect by
springs.
